...
const authMiddleware = require("../middlewares/authMiddleware"); // authMiddleware will be able to access the request and response object
...
router.post("/login", async (req, res) => {
  try {
    ...
    const token = jwt.sign({ userId: user._id }, process.env.jwt_secret, {
      expiresIn: "1d",
    }); //1d means validity for login user
